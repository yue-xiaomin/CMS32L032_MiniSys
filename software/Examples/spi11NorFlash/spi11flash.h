...
**************************************************************************/
#define SPI_WRDR 		(SCI1->SIO11)
#define SPI_RDDR 		(SCI1->SIO11)
#define SPI_BUSY 		(SCI1->SSR11 & _0040_SCI_UNDER_EXECUTE)
#define SPI_RRDY 		(SCI1->SSR11 & _0020_SCI_VALID_STORED)
...
{
	SCI1->ST1 |= _0002_SCI_CH1_START_TRG_ON;
	SCI1->SDR11 = n << 9;	// fMCK/(1+n)x2
	sdr_prescale = n;
