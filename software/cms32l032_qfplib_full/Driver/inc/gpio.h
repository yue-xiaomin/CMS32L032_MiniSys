...
#define   PORT_SetBit(PORTx,PINx)  do{\
											*((volatile uint8_t*)((volatile uint8_t*)&PORT->PSET0+PORTx)) = (1<<PINx);\
										   }while(0)
/*****************************************************************************
 ** \brief	 PORT_ClrBit
 **			 
...
#define   PORT_ClrBit(PORTx,PINx)  do{\
											*((volatile uint8_t*)((volatile uint8_t*)&PORT->PCLR0+PORTx)) = (1<<PINx);\
										   }while(0)
/*****************************************************************************
...
#define   PORT_ToggleBit(PORTx,PINx)  do{\
											*((volatile uint8_t*)((volatile uint8_t*)&PORT->P0+PORTx)) ^= (1<<PINx);\
										   }while(0)
/*****************************************************************************
 ** \brief	 PORT_GetBit
 **	
 ...
 ** \note	 
*****************************************************************************/
#define   PORT_GetBit(PORTx,PINx)  (*((volatile uint8_t*)((volatile uint8_t*)&PORT->PREAD0+PORTx)) & (1<<PINx))

/***********************************************************************************************************************
* Function Name: RESTPinGpio_Set
* @brief  This function set the P01 to gpio or reset pin.
 ** \param [in] RStat: 
 **								1: RESINB pin to gpio
 **								0: RESINB pin to reset pin
* @return None
***********************************************************************************************************************/
